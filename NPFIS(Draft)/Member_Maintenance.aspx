...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtbxLastname" ErrorMessage="Please enter Lastname" Font-Size="Large" ForeColor="Red" ValidationGroup="MMSave">*</asp:RequiredFieldValidator>
        <asp:TextBox ID="txtbxLastname" runat="server" CssClass="form-control" Width="250px"></asp:TextBox>
   ...
   <asp:Label ID="lblDivision" runat="server" Text="Division: *"></asp:Label> &nbsp; 
        <asp:DropDownList
            ID="ddlDivision" runat="server" EnableViewState="true" 
                ...
                <div>
                    Set Member as Active <asp:CheckBox Enabled="true" ID="CheckBox1" runat="server" />
                <br />
...
&nbsp;<asp:TextBox ID="txtbxAddress" Width="300px" Height="100px" 
           ...
           <div class="col-lg-4">
            ...
            <div align="right">
                ...
                <asp:Label ID="lblPercentageofShare" runat="server" Text="Percent Share: *"></asp:Label>
