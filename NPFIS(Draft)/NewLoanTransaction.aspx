    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div style="float: right">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnSave" runat="server" CssClass="btn btn-info btn-sm" Text="Save" OnClick="btnSave_Click" ValidationGroup="InputGroup" Enabled="False" />
                    ...
                    <ContentTemplate>
                        <div style="width: 250px;" class="col-md-4">
                            <div>
                                ...
                                <asp:DropDownList ID="DDLLoanType" runat="server" AutoPostBack="True" CssClass="btn btn-primary dropdown-toggle" OnSelectedIndexChanged="DDLLoanType_SelectedIndexChanged" Width="220px"></asp:DropDownList>
                            </div>
                            <div>
                                ...
                                <asp:TextBox ID="TxtLoanAppNo" runat="server" CssClass="form-control" MaxLength="10"></asp:TextBox>
                            </div>
                            <div>
                            ...
                            <div>
                                <asp:Label ID="Label8" runat="server" Text="Cheque No.: *"></asp:Label>
                                ...
                                <asp:TextBox ID="TxtIssuedCheque" runat="server" CssClass="form-control" MaxLength="10"></asp:TextBox>
                            </div>
                            <div>
                                ...
                                <asp:TextBox ID="TxtIssuedChequeDate" runat="server" CssClass="form-control"></asp:TextBox>
                        ...
                        <div style="width: 200px;" class="col-md-4">
                            ...
                            <div class="checkbox in-line">
                                <center>
                            <br />
                        <asp:CheckBox ID="CkPaidUpLoan" runat="server" Enabled="False" CssClass="checkbox" Text="Paid-up Loan:" AutoPostBack="True" Visible="False" />
                        </center>
                            </div>
                        </div>
                    </ContentTemplate>
