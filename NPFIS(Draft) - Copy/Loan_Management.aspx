            ...
            <asp:Table ID="Table1" runat="server" Width="100%">
                <asp:TableRow runat="server">
                    ...
                    <asp:Label ID="Label1" runat="server" Text="Member: "></asp:Label>
                         ...
                         <asp:DropDownList ID="DDLMember" runat="server" Width="276px" OnSelectedIndexChanged="DDLMember_SelectedIndexChanged" AutoPostBack="True" Enabled="True"></asp:DropDownList>
                    </asp:TableCell>
                    ...
                    <asp:Label ID="Label2" runat="server" Text="Transaction Code: "></asp:Label>
                        <asp:DropDownList ID="ddlTranCode" runat="server" Width="220px" Enabled="True" OnSelectedIndexChanged="ddlTranCode_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
    ...
    <div>                    
        ...
        <asp:Table ID="Table2" runat="server" Width="100%"  style="text-align:right">
            <asp:TableRow runat="server">
                ...
                <asp:DropDownList ID="DDLLoanType" runat="server" Height="19px" Width="170px" OnSelectedIndexChanged="DDLLoanType_SelectedIndexChanged" AutoPostBack="True" Enabled="False"></asp:DropDownList>    
                </asp:TableCell>
                <asp:TableCell runat="server">
